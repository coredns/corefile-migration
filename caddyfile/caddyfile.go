...
// This was copied from github.com/caddyserver/caddy @ tag v.1.0.5
// Taking a module dependency on caddy is very heavyweight, and new versions
// do not expose the parsing used here.
